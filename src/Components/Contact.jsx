        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 grid-cols-1">
            <div className="lg:mb-0 mb-10">
              <div className="group w-full h-full">
                <div className="relative h-full">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14723.044892018417!2d85.91871033240419!3d22.699931064719323!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f5f331199c05d9%3A0xd5b6f727173ebfcf!2sSaraikela%2C%20Jharkhand%20833219!5e0!3m2!1sen!2sin!4v1731518040579!5m2!1sen!2sin"
                    width={600}
                    height={450}
                    style={{ border: 0 }}
                    allowFullScreen=""
                    ...
                    className="w-full h-full lg:rounded-l-2xl rounded bg-blend-multiply
                     object-cover"
                  />
                  ...
                  <div className="absolute bottom-0 w-full lg:p-11 p-5">
                    <div className=" rounded-lg p-6 block">
                      <a href="javascript:;" className="flex items-center mb-6">
                        ...
                        <h5 className="text-gray-400 text-base font-normal leading-6 ml-5">
                          +91-76675-XXXXX
                        </h5>
                      </a>
                      <a href="javascript:;" className="flex items-center mb-6">
                        ...
                        <h5 className="text-gray-400 text-base font-normal leading-6 ml-5">
                          kartikkartikmahato108@gmail.com
                        </h5>
                      </a>
            ...
            <div className=" p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
              ...
              />
              <div className="mb-10 ">
                <h4 className="text-gray-500 text-lg bg-none font-normal leading-7 mb-4">
